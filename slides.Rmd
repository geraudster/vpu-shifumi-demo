...
```{r,Boromir_transfer_learning,out.width='10%', fig.align=center', fig.cap='Boromir transfer learning', echo=FALSE}
...
```{r,image_zenika,out.width='10%', fig.align='right', fig.cap='Exemple shifumi', echo=FALSE}
